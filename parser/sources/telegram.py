...
# Только казахстанские каналы с публичным веб-фидом (t.me/s/).
CHANNELS = [
    ("morepodeshevle", "Ещё Подешевле"),
    ("almaty_promoclub", "Скидки и акции Алматы"),
    ("astana_promoclub", "Скидки и акции Астаны"),
    # podeshevlekz отключён: много статей-советов с ложными % в тексте.
    # ("podeshevlekz", "Казахстан Подешевле"),
    # bsaver_a убран: нет публичного t.me/s/ фида (всегда отдавал 0).
    # aktsiya_telegram НЕ добавляем: российский (Ozon.ru, Wildberries.ru, рубли).
]
